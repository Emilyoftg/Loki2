...
async def start(client, message):
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        await client.send_message(
            ...
            text="♦️ **READ THIS INSTRUCTION** ♦️\n\n🗣 __സീരീസ് X ഗ്രൂപ്പിൽ ചോദിക്കുന്ന സീരിയസ് നിങ്ങൾക്ക്ല ഭിക്കണം എന്നുണ്ടെങ്കിൽ നിങ്ങൾ താഴെ കൊടുത്തിട്ടുള്ള ചാനലിൽ ജോയിൻ ചെയ്യണം. ജോയിൻ ചെയ്ത ശേഷം വീണ്ടും ഗ്രൂപ്പിൽ പോയി ആ ബട്ടനിൽ അമർത്തിയാൽ നിങ്ങൾക്ക് ഞാൻ ആ സീരീസ് പ്രൈവറ്റ് ആയി അയച്ചു തരുന്നതാണ്..__😍\n\n🗣 __In Order To Get The Series Requested By You in Our Groups, You Will Have To Join Our Official Channel First. After That, Try Accessing That Series Again From Our Group Or Click Try Again Button. I'll Send You That Series Privately__ 🙈 \n\n👇 **JOIN THIS CHANNEL & TRY** 👇",
